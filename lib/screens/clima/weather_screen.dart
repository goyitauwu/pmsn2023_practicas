    ...
    return Column(
      ...
      children: [
        ...
        Row(
          ...
          children: [
            _buildTemperatureInfo('Max', '${dailyTemperatures[0]['maxTemperature']}°C'),
            _buildTemperatureInfo('Min', '${dailyTemperatures[0]['minTemperature']}°C'),
          ],
        ),
      ],
    );
      ...
      child: Row(
        ...
        children: [
          ...
          Column(
            mainAxisAlignment: MainAxisAlignment.center,
            children: [
              _buildTemperatureInfo('Max', '${dailyTemperatures[index]['maxTemperature']}°C'),
              _buildTemperatureInfo('Min', '${dailyTemperatures[index]['minTemperature']}°C'),
            ],
          ),
        ],
      ),
